...
$(document).ready(function() {
    ...
    $(document).delegate('.delete-confirm', 'click', function (event) {
        ...
        success: function(response) {
            ...
            if (vendor_list.length > 0) {
                for (var i = 0; i < vendor_list.length; i++) {
                    ...
                    htmls += '<td>' + vendor_list[i].vendor_phone + '</td>';
                    htmls += '<td>' + vendor_list[i].vendor_address + '</td>';
                    htmls += '<td><button class="btn btn-info edit_vendor" row_id="' + vendor_list[i].vendor_id + '">Edit</button><a href="'+Globals.base_url+'/delete_vendor_by_id/'+vendor_list[i].vendor_id+'" class="btn btn-danger delete-confirm delete_vendor" row_id="' + vendor_list[i].vendor_id + '">Delete</a></td>';
                    htmls += '</tr>';
                    j++;
                }
            } else {
            ...
            if (admin_cat_list.length > 0) {
                for (var i = 0; i < admin_cat_list.length; i++) {
                    ...
                    admin_cat_htm += '<td>' + ac + '</td>';
                    admin_cat_htm += '<td>' + admin_cat_list[i].purchase_cat_name + '</td>';
                    admin_cat_htm += '<td><button cat_type="1" class="btn btn-info edit_cat" row_id="' + admin_cat_list[i].admin_purchase_categeorie_id + '">Edit</button><a href="'+Globals.base_url+'/delete_admin_purchase_categeorie/'+admin_cat_list[i].admin_purchase_categeorie_id+'" cat_type="1" class="btn btn-danger delete-confirm delete_cat" row_id="' + admin_cat_list[i].admin_purchase_categeorie_id + '">Delete</a></td>';
                    admin_cat_htm += '</tr>';
                    ac++;
                }
            } else {
            ...
            if (product_cat_list.length > 0) {
                for (var i = 0; i < product_cat_list.length; i++) {
                    ...
                    pr_cat_htm += '<td>' + pc + '</td>';
                    pr_cat_htm += '<td>' + product_cat_list[i].category_name + '</td>';
                    pr_cat_htm += '<td><button cat_type="2" class="btn btn-info edit_cat" row_id="' + product_cat_list[i].product_categorie_id + '">Edit</button><a href="'+Globals.base_url+'/delete_product_category_by_id/'+product_cat_list[i].product_categorie_id+'" cat_type="2" class="btn btn-danger delete-confirm delete_cat" row_id="' + product_cat_list[i].product_categorie_id + '">Delete</a></td>';
                    pr_cat_htm += '</tr>';
                    pc++;
                }
            } else {
            ...
            if (product_sub_cat_list.length > 0) {
                for (var i = 0; i < product_sub_cat_list.length; i++) {
                    ...
                    pr_sub_cat_htm += '<td><button class="btn btn-info edit_product_sub_cat" parent_cat_id="' + product_sub_cat_list[i].product_categorie_id + '" row_id="' + product_sub_cat_list[i].product_sub_categorie_id + '"><i class="material-icons">edit</i></button><a href="'+Globals.base_url+'/delete_product_sub_category_by_id/'+product_sub_cat_list[i].product_sub_categorie_id+'" class="btn btn-danger delete-confirm delete_product_sub_cat" row_id="' + product_sub_cat_list[i].product_sub_categorie_id + '"><i class="material-icons">delete_forever</i></a></td>';
                    pr_sub_cat_htm += '</tr>';
                    psc++;
                }
            } else {
