...
class roleHasPermissionsTableDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role_admin->givePermissionTo('outlet_access','view_main','change_password','create_roles','retrieve_roles','create_permissions','retrieve_permissions','create_users','retrieve_users');
