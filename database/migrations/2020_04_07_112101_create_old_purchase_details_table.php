...
class CreateOldPurchaseDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('old_purchase_details', function (Blueprint $table) {
            $table->increments('old_purchase_detail_id')->comment('old_purchase_detail_id');
            $table->integer('old_purchase_id')->unsigned()->comment('old_purchase_id');
