...
class CreateSalesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales', function (Blueprint $table) {
            $table->increments('sale_id')->comment('sale_id');
			...
			$table->float('sale_amount', 11,2)->comment('vori')->nullable();
			...
			$table->float('making_cost', 11,2)->comment('vori')->nullable();
			...
			$table->date('sale_date')->comment('sale_date')->nullable();
			...
			$table->dateTime('sale_datetime')->comment('sale_datetime')->nullable();
            $table->enum('sale_status', ['0', '1'])->default('1')->comment('1 saled 0 ordered data');
