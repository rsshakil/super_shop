        ...
        <div class="col">
            <div class="card card-small mb-4">
                ...
                <div class="card-body p-0 pb-0 text-center">
                    ...
                    <input type="hidden" class="return_id" value="0">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <button user_type="1" class="btn btn-primary add_new_maker">Add customer</button>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control return_type" name="return_type">
                                ...
                                <option value="1">Sell to shop</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <table id="user_list_tbl" class="table table-bordered mb-0">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="return_decrease_amount">0.00</td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="td_no_padding"><input type="number" onkeyup="javascript:add_return_calculation();" class="form-control sale_td_input_cs discount_amount" value="0"></td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="td_no_padding"><input type="number" onkeyup="javascript:add_return_calculation();" class="form-control sale_td_input_cs total_paid_amount" value="0"></td>
                                <td></td>
                            </tr>
                            <tr>
                    ...
                    <button type="submit" class="btn btn-primary add_return_to_db">Add Return</button>
                </div>
            </div>
        </div>
    </div>
