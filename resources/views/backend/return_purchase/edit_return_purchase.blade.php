...
<div class="main-content-container container-fluid px-4">
   ...
   $sale_item = $data['sale_item']->original['return_list'];
        ...
        <div class="col">
            <div class="card card-small mb-4">
                ...
                <div class="card-body p-0 pb-0 text-center">
                    ...
                    <input type="hidden" class="return_id" value="{{$sale_item[0]->sale_id}}">
                                ...
                                <?php 
                                    ...
                                    if($payment_list_types){
                                        ...
                                        foreach($payment_list_types as $val){
                                            ...
                                            echo '<option value="'.$val['payment_type_id'].'" '.$selected_payment.'>'.$val['payment_type_name'].'</option>';
                                        }
                                    }
                                ?>
                            </select>
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label">Return type </label>
                        <div class="col-md-8">
                            <select class="form-control return_type" name="return_type">
                                <option value="0" <?php echo $retun_t = (0==$sale_item[0]->return_type?'selected':'');?>>Exchange</option>
                                <option value="1" <?php echo $retun_t = (1==$sale_item[0]->return_type?'selected':'');?>>Sell to shop</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="product_barcode_return" class="col-md-4 col-form-label">Product barcode</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control product_barcode_return" name="product_barcode_return">
                        </div>
                    </div>
                    <table id="user_list_tbl" class="table table-bordered mb-0">
                        ...
                        <tbody class="product_sale_data">
                            ...
                            @foreach($product_item as $item)
                                <tr>
                                    ...
                                    <td>{{$item->unit_price_per_gram*$item->weight}}</td>
                                    <td><button class="btn btn-danger delete_p_row_return">Delete</button></td>
                                </tr>
                                <?php $i++;?>
                            @endforeach;
                        </tbody>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td colspan="6" style="text-align:right;">Decrease amount</td>
                                <td class="return_decrease_amount">{{$sale_item[0]->return_decrease_amount}}</td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="6" style="text-align:right;">Extra Amount</td>
                                <td class="td_no_padding"><input type="number" onkeyup="javascript:add_return_calculation();" class="form-control sale_td_input_cs discount_amount" value="{{$sale_item[0]->discount_amount}}"></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="6" style="text-align:right;">Total Payable Amount</td>
                                <td class="total_payable_amount">{{$sale_item[0]->purchase_amount}}</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="6" style="text-align:right;">Paid Amount</td>
                                <td class="td_no_padding"><input type="number" onkeyup="javascript:add_return_calculation();" class="form-control sale_td_input_cs total_paid_amount" value="{{$sale_item[0]->paid_amount}}"></td>
                                <td></td>
                            </tr>
                            <tr>
                    ...
                    <button type="submit" class="btn btn-primary add_return_to_db">Update Return</button>
                </div>
            </div>
        </div>
    </div>
